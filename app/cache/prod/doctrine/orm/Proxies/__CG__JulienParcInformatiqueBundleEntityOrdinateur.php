 ...
 */
class Ordinateur extends \Julien\ParcInformatiqueBundle\Entity\Ordinateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'salle', 'reference', 'os', 'package');
    }
