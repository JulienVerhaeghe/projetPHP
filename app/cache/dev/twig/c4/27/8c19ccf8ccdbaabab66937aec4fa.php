...
/* JulienParcInformatiqueBundle:parcInfo:voir_liste_logiciel.html.twig */
class __TwigTemplate_c4278c19ccf8ccdbaabab66937aec4fa extends Twig_Template
{
...
";
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["package"]) {
            // line 14
            echo "          <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("parcInfo_voir_logiciel", array("id" => $this->getAttribute($this->getContext($context, "package"), "id"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "package"), "name"), "html", null, true);
            echo "</a>  <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("parcInfo_modifier_logiciel", array("id" => $this->getAttribute($this->getContext($context, "package"), "id"))), "html", null, true);
            echo "\" class=\"btn\">Modifier</a>
                      <a href=\"";
            // line 15
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("parcInfo_supprimer_logiciel", array("id" => $this->getAttribute($this->getContext($context, "package"), "id"))), "html", null, true);
...
";
    ...
    {
        return "JulienParcInformatiqueBundle:parcInfo:voir_liste_logiciel.html.twig";
    }
