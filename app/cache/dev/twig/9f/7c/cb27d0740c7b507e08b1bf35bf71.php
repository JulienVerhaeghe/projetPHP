...
/* JulienParcInformatiqueBundle:parcInfo:modifier.html.twig */
class __TwigTemplate_9f7ccb27d0740c7b507e08b1bf35bf71 extends Twig_Template
{
...
";
  ...
  <p>
    <a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("parcInfo_voir", array("id" => $this->getAttribute($this->getContext($context, "article"), "id"))), "html", null, true);
        echo "\" class=\"btn\">
...
";
    ...
    {
        return "JulienParcInformatiqueBundle:parcInfo:modifier.html.twig";
    }
